...
class RugbyTvConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry):
        return RugbyTvOptionsFlow(config_entry)


class RugbyTvOptionsFlow(config_entries.OptionsFlow):
